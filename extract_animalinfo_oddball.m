...
xlsfn = '/media/sde_WD6T/slee_tp_data/doc/Oddball.xlsx'
...
for inx = 1%: length(ses_inx)
    try
        ...
        main_datpath='/media/sde_WD6T/slee_tp_data/DATA1/';
        ...
        ss = ss.autofill({'ch1_color','red','ch2_color','green',...
            ...
            'fov','FOV1','depth',depth,'layer','L2/3'}, scanlist);
        ...
        ss = ss.autofill({'ch1_color','red','ch2_color','green',...
            'scanmethod','spiral','area','V1',...
            'dwell_time',0.8,'pixres',0.89,'objective','16x',...          
            'fov','FOV2','depth',depth,'layer','L4'}, scanlist);
        
        
        ss = ss.gen_datfn;
        [tscan, zscan] = ss.get_validscanlist;
       
        fldlist={'animal_id','session_id', 'scan_id', 'data_path', 'data_fn1',...
            'data_fn2','ch2_color', 'scanmethod','anesthesia',...
            'dwell_time','pixres','objective',...
            'area', 'layer', 'depth', 'laser_wavelength', 'fov','scan_notes'};

        ss = ss.create_datstr(fldlist,tscan);
